...
export default function Practice() {
  ...
  useEffect(() => {
    const iv = setInterval(async () => {
      ...
      if (!lid) return;
      try {
        await axios.post("https://typing-portal-es53.onrender.com/api/live-practice", {
          login_id:      lid,
  ...
  const createLoginActivity = async (lang) => {
    try {
      ...
      const res = await axios.post("https://typing-portal-es53.onrender.com/student-login-activity", {
  ...
  const savePractice = async () => {
    try {
      const lid = loginIdRef.current;
      if (!lid) return;
      await axios.post("https://typing-portal-es53.onrender.com/save-practice", {
